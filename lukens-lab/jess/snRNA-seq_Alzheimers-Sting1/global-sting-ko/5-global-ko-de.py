...
# -*- coding: utf-8 -*-
"""
Created on Sun May 19 11:25:08 2024
...
## Save directory
save_dir = "/Users/maureen/Documents/projects/lukens-lab/jess/Thanos_AD-Sting_snRNAseq/analysis-4/global-sting-ko/results/spreadsheets/de"
...
filtered_de_cell_type.to_csv(os.path.join(save_dir, 'global-sting-wt-ko-DE-cell_type.csv'), index = False)

#results_cell_type['log2fc'] = -results_cell_type['log2fc']
#results_cell_type.to_csv(os.path.join(save_dir, 'global-sting-wt-ko-DE-cell_type.csv'), index = False)
...
if not de_df_sorted.empty:
    ...
    filtered_adata = adata[(adata.obs['group'].isin(['WT', 'Sting1-KO'])) & (adata.obs['cell_type'] == specific_cell_type)]
    a = filtered_adata[filtered_adata.obs['group'] == 'WT', i].X
    b = filtered_adata[filtered_adata.obs['group'] == 'Sting1-KO', i].X
...
#filtered_de_cluster.to_csv(os.path.join(save_dir, 'global-sting-wt-ko-DE-cluster.csv'), index = False)
